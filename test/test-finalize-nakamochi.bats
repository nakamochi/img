...
@test "Test patching bitcoind configuration" {
    ...
    patch_bitcoind_conf "$tempdir/mainnet.conf" "$bitcoind_rpcauth_1" "$bitcoind_onion_1"
    ...
    patch_bitcoind_conf "$tempdir/mainnet.conf" "$bitcoind_rpcauth_2" "$bitcoind_onion_2"
    run grep "^rpcauth=" "$tempdir/mainnet.conf"
